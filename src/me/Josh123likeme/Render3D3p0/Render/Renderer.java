	...
	public void render(Graphics g, World world, Camera cam) {
		...
		for (Triangle triangle : triangles) {
			...
			for (int i = 0; i < 3; i++) {
				...
				final double fy2 = fx * sinYaw + fy * cosYaw;
				
				double x = fx * cosYaw -fy * sinYaw;
				double z = fy2 * sinPitch + fz * cosPitch;
				
				double y = -fy2 * cosPitch + fz * sinPitch;
